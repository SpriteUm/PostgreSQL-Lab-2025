...
สิทธิ์ (privileges) ที่มอบให้กับ role postgres โดยมีอักษรย่อแทนสิทธิ์ต่างๆ
...
จากข้อมูลที่เราวิเคราะห์ พบว่าสินค้าที่ขายดีที่สุด 5 อันดับแรก มักจะเป็นสินค้าที่เป็นที่นิยมและเข้าถึงง่าย เช่น เสื้อยืด, หูฟังไร้สาย, และรองเท้า Sneakers เพราะคนซื้อบ่อยและราคาไม่สูงมาก

เมื่อดูยอดขายรวมตามหมวดหมู่ จะเห็นว่า Electronics มียอดขายสูงที่สุด เนื่องจากมีสินค้าราคาสูงอย่าง iPhone, MacBook และ Samsung Galaxy ตามมาด้วยหมวด Clothing และ Sports ที่คนซื้อสินค้าบ่อยแต่ราคาต่ำกว่า

สำหรับลูกค้าที่ซื้อสินค้ามากที่สุด คือ John Smith เพราะซื้อหลายครั้ง และสั่งทั้ง iPhone, Gaming Mouse รวมถึง Programming Book ทำให้ยอดรวมของเขาสูงกว่าลูกค้าคนอื่นๆ
...
1. Named Volume เป็นพื้นที่เก็บข้อมูลที่ Docker จัดการให้เอง ใช้สะดวกและเหมาะสำหรับเก็บข้อมูลถาวรของ PostgreSQL
ส่วน Bind Mount จะผูก directory หรือไฟล์จากเครื่อง host โดยตรง เหมาะสำหรับการพัฒนาเพราะแก้ไฟล์บน host แล้วสะท้อนเข้า container ได้ทันที

2. shared_buffers ควรตั้งประมาณ 25% ของ RAM เพราะเป็นค่าที่เหมาะสมในการใช้หน่วยความจำสำหรับ cache ข้อมูลใน PostgreSQL
ถ้าตั้งสูงเกินไปจะไปแย่ง RAM ที่จำเป็นกับระบบปฏิบัติการและ process อื่น แต่ถ้าต่ำเกินไปประสิทธิภาพการ query จะลดลง

3. การใช้ Schema ช่วยจัดระเบียบข้อมูล โดยแยกกลุ่มตาราง ฟังก์ชัน และ object ต่าง ๆ ออกจากกันทำให้การจัดการฐานข้อมูลขนาดใหญ่เป็นระบบมากขึ้น

4. การใช้ Docker ช่วยให้การพัฒนา Database สะดวก เพราะสามารถสร้างสภาพแวดล้อมที่เหมือนกันทุกเครื่อง
ลดปัญหา "มันรันได้บนเครื่องฉัน แต่ไม่รันบนเครื่องคุณ" และสามารถทดสอบ, รีเซ็ต หรือรันหลาย instance ของ PostgreSQL ได้อย่างรวดเร็ว
```
